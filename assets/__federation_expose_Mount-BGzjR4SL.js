...
const Sidebar = /*#__PURE__*/_export_sfc(_sfc_main$2, [['__scopeId',"data-v-0466cd4c"]]);
...
const _hoisted_6 = { class: "list-items" };
const _hoisted_7 = ["id", "onUpdate:modelValue"];
const _hoisted_8 = ["for"];
const _hoisted_9 = { class: "entry-box" };
    ...
    _createElementVNode$1("div", _hoisted_3, [
      (!_unref(listStore).selectedList)
        ...
        : (_openBlock$2(), _createElementBlock$2("div", _hoisted_5, [
            _createElementVNode$1("ul", _hoisted_6, [
              (_openBlock$2(true), _createElementBlock$2(_Fragment, null, _renderList(_unref(listStore).selectedList.items, (item, index) => {
                return (_openBlock$2(), _createElementBlock$2("li", {
                  ...
                  _withDirectives(_createElementVNode$1("input", {
                    ...
                    [_vModelCheckbox, item.completed]
                  ]),
            ...
            _createElementVNode$1("p", _hoisted_9, [
...
const ListResults = /*#__PURE__*/_export_sfc(_sfc_main$1, [['__scopeId',"data-v-8ea83cbb"]]);
