...
return (_ctx, _cache) => {
  return (_openBlock$3(), _createElementBlock$3("form", {
    onSubmit: _cache[7] || (_cache[7] = _withModifiers($event => (_unref$1(listStore).updateItemEntry(__props.itemId, updatedEntry.value)), ["prevent"])),
...
const Result = /*#__PURE__*/_export_sfc(_sfc_main$2, [['__scopeId',"data-v-2b3cc867"]]);
