...
return (_ctx, _cache) => {
  return (_openBlock$6(), _createElementBlock$6("button", {
    ...
    (!isEditing.value)
      ? (_openBlock$6(), _createElementBlock$6("div", _hoisted_3$3, [
...
const ListTitle = /*#__PURE__*/_export_sfc(_sfc_main$5, [['__scopeId',"data-v-09fc8b8a"]]);
...
const {createElementVNode:_createElementVNode$4,createVNode:_createVNode$3,unref:_unref$3,openBlock:_openBlock$4,createElementBlock:_createElementBlock$4,createCommentVNode:_createCommentVNode$3,createBlock:_createBlock,renderList:_renderList$1,Fragment:_Fragment$1} = await importShared('vue');
...
return (_ctx, _cache) => {
  return (_openBlock$4(), _createElementBlock$4("nav", _hoisted_1$3, [
    ...
    (_unref$3(listStore).creatingList === false)
      ? (_openBlock$4(), _createElementBlock$4("button", {
          ...
          _createElementVNode$4("img", {
            class: "icon-plus",
            src: isDark.value ? _unref$3(plusWhite) : _unref$3(plusBlack),
            alt: "ajouter une liste"
          }, null, 8, _hoisted_2$3),
          _cache[1] || (_cache[1] = _createElementVNode$4("p", { class: "button-text" }, "Nouvelle Liste", -1))
        ]))
    ...
    ? (_openBlock$2(), _createElementBlock$2("div", {
        ...
        _createElementVNode$2("div", _hoisted_4$1, [
          (!_unref$1(listStore).selectedList)
            ? (_openBlock$2(), _createElementBlock$2("p", _hoisted_5$1, _cache[3] || (_cache[3] = [
            ...
            : (_openBlock$2(), _createElementBlock$2("div", _hoisted_6, [
                ...
                (_unref$1(listStore).selectedList.type === 'classic')
                  ...
                  : _createCommentVNode$1("", true),
                _cache[4] || (_cache[4] = _createElementVNode$2("p", { class: "info" }, "⭐️Appuie sur une Entrée pour ajouter", -1))
              ]))
        ])
      ], 2))
    : _createCommentVNode$1("", true)
