...
const {unref:_unref$3,createElementVNode:_createElementVNode$4,openBlock:_openBlock$5,createElementBlock:_createElementBlock$5} = await importShared('vue');
...
const {unref:_unref$2,createVNode:_createVNode$1,createElementVNode:_createElementVNode$3,vModelText:_vModelText,withDirectives:_withDirectives,renderList:_renderList$1,Fragment:_Fragment$1,openBlock:_openBlock$4,createElementBlock:_createElementBlock$4,toDisplayString:_toDisplayString$1,normalizeClass:_normalizeClass,withModifiers:_withModifiers,normalizeStyle:_normalizeStyle$1} = await importShared('vue');
...
return (_ctx, _cache) => {
  return (_openBlock$4(), _createElementBlock$4("div", {
    ...
    style: _normalizeStyle$1({ backgroundColor: _unref$2(typeList).find(item => item.type === selectedType.value)?.color || 'white' })
  }, [
    ...
    _createElementVNode$3("form", {
      ...
      _createElementVNode$3("div", _hoisted_2$2, [
        ...
        _withDirectives(_createElementVNode$3("input", {
          class: "title-input",
      ...
      _createElementVNode$3("div", _hoisted_3$1, [
        ...
        _createElementVNode$3("div", _hoisted_4$1, [
          (_openBlock$4(true), _createElementBlock$4(_Fragment$1, null, _renderList$1(_unref$2(typeList), (item) => {
            return (_openBlock$4(), _createElementBlock$4("div", {
              class: _normalizeClass(["type-option", { selected: selectedType.value === item.type }]),
              key: item.type,
              onClick: $event => (selectedType.value = item.type)
            }, [
              _createElementVNode$3("p", _hoisted_6, _toDisplayString$1(item.label), 1),
        ...
        _createElementVNode$3("p", _hoisted_8, _toDisplayString$1(_unref$2(typeList).find(item => item.type === selectedType.value)?.description), 1)
      ]),
...
const {createElementVNode:_createElementVNode$2,toDisplayString:_toDisplayString,unref:_unref$1,normalizeStyle:_normalizeStyle,openBlock:_openBlock$3,createElementBlock:_createElementBlock$3} = await importShared('vue');
...
return (_ctx, _cache) => {
  return (_openBlock$3(), _createElementBlock$3("button", {
    ...
    _createElementVNode$2("div", _hoisted_1$3, [
      ...
      _createElementVNode$2("p", _hoisted_3, _toDisplayString(__props.title), 1)
    ]),
...
const ListTitle = /*#__PURE__*/_export_sfc(_sfc_main$3, [['__scopeId',"data-v-5eb8b265"]]);

const {createElementVNode:_createElementVNode$1,unref:_unref,openBlock:_openBlock$2,createElementBlock:_createElementBlock$2,createCommentVNode:_createCommentVNode,createBlock:_createBlock,renderList:_renderList,Fragment:_Fragment} = await importShared('vue');
...
const Sidebar = /*#__PURE__*/_export_sfc(_sfc_main$2, [['__scopeId',"data-v-02b6a96e"]]);
...
const ListeView = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-76a15153"]]);
