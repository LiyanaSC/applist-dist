...
return (_ctx, _cache) => {
  return (_openBlock$7(), _createElementBlock$7("div", {
    ...
    style: _normalizeStyle$1({background: _unref$4(typeList)[0].color || 'white' })
  }, [
    ...
    _createElementVNode$6("form", {
      ...
      _createElementVNode$6("div", _hoisted_2$4, [
        _cache[4] || (_cache[4] = _createElementVNode$6("label", {
          class: "subtitle",
          for: "title"
        }, "Nom de la liste", -1)),
...
const {toDisplayString:_toDisplayString$2,openBlock:_openBlock$6,createElementBlock:_createElementBlock$6,createCommentVNode:_createCommentVNode$3,vModelText:_vModelText$2,unref:_unref$3,withKeys:_withKeys$2,withDirectives:_withDirectives$2,createElementVNode:_createElementVNode$5,normalizeStyle:_normalizeStyle} = await importShared('vue');
...
return (_ctx, _cache) => {
  return (_openBlock$6(), _createElementBlock$6("button", {
    ...
    _createElementVNode$5("div", _hoisted_1$5, [
      (!isEditing.value)
        ? (_openBlock$6(), _createElementBlock$6("p", _hoisted_2$3, _toDisplayString$2(newTitle.value), 1))
    ...
    (!isEditing.value)
      ? (_openBlock$6(), _createElementBlock$6("div", _hoisted_3$2, [
          ...
          _createElementVNode$5("img", {
            ...
            src: _unref$3(trash),
            alt: "supprimer",
            onClick: _cache[3] || (_cache[3] = $event => {stopPropagation(); _unref$3(listStore).deleteList(__props.listId);})
          }, null, 8, _hoisted_5$2)
        ]))
      : (_openBlock$6(), _createElementBlock$6("div", _hoisted_6$2, [
          _createElementVNode$5("img", {
            ...
            src: _unref$3(check),
            alt: "valider",
            onClick: _cache[4] || (_cache[4] = $event => {stopPropagation(); _unref$3(listStore).editListTitle(__props.listId, newTitle.value); closeEditMode();})
          }, null, 8, _hoisted_7$2),
          _createElementVNode$5("img", {
            class: "icon-edit",
            src: _unref$3(cross),
...
const ListTitle = /*#__PURE__*/_export_sfc(_sfc_main$5, [['__scopeId',"data-v-d996763c"]]);
...
const Sidebar = /*#__PURE__*/_export_sfc(_sfc_main$3, [['__scopeId',"data-v-65761821"]]);
...
return (_ctx, _cache) => {
  return (_openBlock$3(), _createElementBlock$3("form", {
    onSubmit: _cache[7] || (_cache[7] = _withModifiers($event => (submitUpdate()), ["prevent"])),
...
const Result = /*#__PURE__*/_export_sfc(_sfc_main$2, [['__scopeId',"data-v-e76f4c5c"]]);
...
const ListResults = /*#__PURE__*/_export_sfc(_sfc_main$1, [['__scopeId',"data-v-c4625acc"]]);
...
const ListeView = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-a2b8bbe0"]]);
