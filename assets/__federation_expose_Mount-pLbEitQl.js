...
const ListeView = /*#__PURE__*/_export_sfc(_sfc_main$1, [['__scopeId',"data-v-96f7eec3"]]);
...
if (!window.__POWERED_BY_FEDERATION__) {
  createMyApp(App, '#applist');// Si ce microfrontend est exécuté en mode développement (standalone), on monte directement l'application avec le composant App dans l'élément avec l'id 'app'
}
