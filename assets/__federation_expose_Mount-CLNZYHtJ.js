  ...
  return (_openBlock$3(), _createElementBlock$3("nav", _hoisted_1$2, [
    ...
    (_openBlock$3(true), _createElementBlock$3(_Fragment$1, null, _renderList$1(_unref$1(listStore).lists, (item, index) => {
      return (_openBlock$3(), _createBlock(ListTitle, {
        ...
        onClick: $event => (_unref$1(listStore).selectList(item._id))
...
const Sidebar = /*#__PURE__*/_export_sfc(_sfc_main$2, [['__scopeId',"data-v-49709f16"]]);
    ...
    ? (_openBlock$2(), _createElementBlock$2("div", {
        ...
        _createElementVNode$1("div", _hoisted_4, [
          (!_unref(listStore).selectedList)
            ? (_openBlock$2(), _createElementBlock$2("p", _hoisted_5, _cache[4] || (_cache[4] = [
            ...
            : (_openBlock$2(), _createElementBlock$2("div", _hoisted_6, [
                      ...
                      (_openBlock$2(true), _createElementBlock$2(_Fragment, null, _renderList(_unref(listStore).selectedList.items, (item, index) => {
                        return (_openBlock$2(), _createElementBlock$2("li", {
                          ...
                          _createElementVNode$1("input", {
                            ...
                            id: item._id,
                            checked: item.done,
                            onChange: $event => (_unref(listStore).toggleItemCompletion(item._id))
                          }, null, 40, _hoisted_8),
                ...
                (_unref(listStore).selectedList.type === 'classic')
                  ? (_openBlock$2(), _createElementBlock$2("p", {
                      key: 1,
                      class: _normalizeClass(isFocus.value ? 'entry-box-focus' : 'entry-box')
                    }, [
                      _createElementVNode$1("span", _hoisted_10, [
                        _withDirectives(_createElementVNode$1("input", {
                          ...
                          onBlur: _cache[3] || (_cache[3] = $event => (isFocus.value=false))
                        }, null, 544), [
                        ...
                        (entry.value ? true : false)
                          ...
                          : (_openBlock$2(), _createElementBlock$2("label", _hoisted_13, [
                              _createElementVNode$1("img", {
                  ...
                  : _createCommentVNode("", true),
                _cache[5] || (_cache[5] = _createElementVNode$1("p", { class: "info" }, "⭐️Appuie sur une Entrée pour ajouter", -1))
              ]))
        ])
      ], 2))
    : _createCommentVNode("", true)
...
const ListResults = /*#__PURE__*/_export_sfc(_sfc_main$1, [['__scopeId',"data-v-4540b85e"]]);
