    ...
    (!isEditing.value)
      ...
      : (_openBlock$3(), _createElementBlock$3("div", _hoisted_6$1, [
          _createElementVNode$2("img", {
            ...
            src: _unref$1(check),
            alt: "valider",
            onClick: _cache[6] || (_cache[6] = $event => {_unref$1(listStore).updateItemEntry(__props.itemId, updatedEntry.value.value); closeEditMode();})
          }, null, 8, _hoisted_7$1),
          _createElementVNode$2("img", {
            class: "icon-edit",
            src: _unref$1(cross),
...
const Result = /*#__PURE__*/_export_sfc(_sfc_main$2, [['__scopeId',"data-v-15f5a647"]]);
