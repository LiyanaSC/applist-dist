...
const ListeView = /*#__PURE__*/_export_sfc(_sfc_main$1, [['__scopeId',"data-v-f1ffc003"]]);
...
function createMyApp(Component, el) {
  ...
  console.log("MFE ?", window.__POWERED_BY_FEDERATION__);
  console.log("Mode MFE");
  console.log("Environnement :", window.__POWERED_BY_FEDERATION__ ? "MFE" : "DEV");
}
function mount(el) {
