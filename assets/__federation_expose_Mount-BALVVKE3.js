...
const ListTitle = /*#__PURE__*/_export_sfc(_sfc_main$3, [['__scopeId',"data-v-9d05c7d4"]]);

const {createElementVNode:_createElementVNode$2,createTextVNode:_createTextVNode$1,unref:_unref$1,openBlock:_openBlock$3,createElementBlock:_createElementBlock$3,createCommentVNode:_createCommentVNode,createBlock:_createBlock,renderList:_renderList,Fragment:_Fragment} = await importShared('vue');
...
return (_ctx, _cache) => {
  return (_openBlock$3(), _createElementBlock$3("nav", _hoisted_1$2, [
    _cache[2] || (_cache[2] = _createElementVNode$2("h2", { class: "sidebar-title-box" }, [
      _createTextVNode$1(" ✨ "),
      _createElementVNode$2("span", { class: "sidebar-title-text" }, "Mes Listes"),
      _createTextVNode$1(" ✨ ")
    ], -1)),
    (!showForm.value)
    ...
    (showForm.value)
      ? (_openBlock$3(), _createBlock(_sfc_main$4, {
          key: 1,
...
const Sidebar = /*#__PURE__*/_export_sfc(_sfc_main$2, [['__scopeId',"data-v-6c61bd3d"]]);

const {unref:_unref,toDisplayString:_toDisplayString,createElementVNode:_createElementVNode$1,createTextVNode:_createTextVNode,openBlock:_openBlock$2,createElementBlock:_createElementBlock$2} = await importShared('vue');
...
return (_ctx, _cache) => {
  return (_openBlock$2(), _createElementBlock$2("div", _hoisted_1$1, [
    ...
    _cache[0] || (_cache[0] = _createElementVNode$1("div", { class: "content-list" }, [
      _createElementVNode$1("p", null, [
        ...
        _createElementVNode$1("br"),
        _createElementVNode$1("span", { class: "yellow-heart" }, "💛")
      ])
    ], -1))
  ]))
}
...
const ListResults = /*#__PURE__*/_export_sfc(_sfc_main$1, [['__scopeId',"data-v-5195690a"]]);
