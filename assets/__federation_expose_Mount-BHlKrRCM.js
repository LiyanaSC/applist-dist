    ...
    (!isEditing.value)
      ? (_openBlock$5(), _createElementBlock$5("div", _hoisted_4$1, [
          ...
          _createElementVNode$4("img", {
            ...
            src: _unref$2(trash),
            alt: "supprimer",
            onClick: _cache[2] || (_cache[2] = $event => (_unref$2(listStore).deleteList(__props.listId)))
          }, null, 8, _hoisted_6$1)
        ]))
      : (_openBlock$5(), _createElementBlock$5("div", _hoisted_7$1, [
          ...
          _createElementVNode$4("img", {
            ...
            src: _unref$2(cross),
            alt: "annuler",
            onClick: _cache[3] || (_cache[3] = $event => (isEditing.value = false))
          }, null, 8, _hoisted_9$1)
        ]))
  ], 4))
}
...
const ListTitle = /*#__PURE__*/_export_sfc(_sfc_main$4, [['__scopeId',"data-v-24cc5276"]]);
...
const Sidebar = /*#__PURE__*/_export_sfc(_sfc_main$2, [['__scopeId',"data-v-5dfa51e3"]]);
...
return (_ctx, _cache) => {
  return (_unref(isMobile) ? _unref(listStore).showListResults  : !_unref(listStore).showListResults )
...
const ListResults = /*#__PURE__*/_export_sfc(_sfc_main$1, [['__scopeId',"data-v-ed36d5df"]]);
